...
Bot de monitoramento de preços da Amazon usando Python e Selenium. Verifica automaticamente o preço de um produto e envia um e-mail de alerta quando o preço muda.
